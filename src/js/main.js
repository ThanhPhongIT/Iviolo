...
$(document).ready(function(){
  ...
  // start toggle nav filter
  $(".icon-nav-category").click(function(){
    $(this).toggleClass("active");
    $('.right-filter').toggleClass("show-filter");
  });
...
$(document).ready(function() {
  ...
  $(".noUi-handle.noUi-handle-lower").html('<span id="slider-range-value1">$50</span>');
  $(".noUi-handle.noUi-handle-upper").html('<span id="slider-range-value2">$1200</span>');

});
// end config ranger slider
